...
- **Cliente-Servidor**: Arquitectura de solicitud-respuesta
- **Basado en texto**: Mensajes legibles por humanos
- **Flexible**: Puede transportar cualquier tipo de dato
- **Cacheable**: Permite almacenamiento temporal
...
- [REST API](/concepts/rest-api) - Arquitectura sobre HTTP
- [CORS](/concepts/cors) - Políticas de origen cruzado
- [Authentication](/concepts/authentication) - Autenticación web
- [Caching](/concepts/caching) - Almacenamiento en cache
- [SSL/TLS](/concepts/ssl-tls) - Cifrado para HTTPS
- [Web APIs](/concepts/web-apis) - APIs basadas en HTTP
