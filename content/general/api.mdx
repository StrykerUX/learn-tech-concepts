...
Una API (Application Programming Interface) es un **conjunto de reglas y protocolos** que permite que diferentes aplicaciones, servicios o sistemas se comuniquen entre sí de manera estandarizada.
