...
- [JavaScript](/terminos/frontend/javascript) - Base de TypeScript
- [React](/terminos/frontend/react) - Se puede usar con TypeScript
- [Next.js](/terminos/frontend/nextjs) - Soporte nativo para TypeScript
- [Node.js](/terminos/backend/nodejs) - TypeScript en el backend
- [Interfaces](/terminos/programming/interfaces) - Definición de contratos
