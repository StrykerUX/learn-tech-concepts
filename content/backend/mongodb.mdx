...
- **Orientada a documentos**: Datos almacenados como documentos JSON
- **Esquema flexible**: No requiere estructura fija
- **Escalabilidad horizontal**: Fácil distribución
- **Consultas potentes**: Soporte para consultas complejas
...
- [Node.js](/backend/nodejs) - Plataforma popular para MongoDB
- [Express](/backend/express) - Framework para APIs con MongoDB
- [NoSQL](/concepts/nosql) - Tipo de base de datos
- [JSON](/concepts/json) - Formato de datos
- [Database](/concepts/database) - Conceptos generales
- [Mongoose](/backend/mongoose) - ODM para Node.js
