...
JSON se caracteriza por:

- **Basado en texto**: Formato de texto plano
- **Independiente del lenguaje**: Usado en casi todos los lenguajes
- **Sintaxis simple**: Basado en JavaScript pero universal
- **Ligero**: Mínimo overhead
- **Legible**: Fácil de leer por humanos
...
- [REST API](/concepts/rest-api) - APIs que usan JSON
- [JavaScript](/frontend/javascript) - Origen de JSON
- [HTTP](/concepts/http) - Protocolo que transporta JSON
- [API](/general/api) - Intercambio de datos
- [XML](/concepts/xml) - Formato alternativo
- [YAML](/concepts/yaml) - Formato más legible
