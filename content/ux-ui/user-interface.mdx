...
- **Apariencia visual**: Cómo se ve el producto
- **Interactividad**: Cómo responde a las acciones
- **Elementos gráficos**: Botones, iconos, imágenes
- **Layout**: Disposición de elementos
- **Consistencia**: Uniformidad visual
...
- [User Experience (UX)](/ux-ui/user-experience) - Experiencia completa
- [CSS](/frontend/css) - Estilos de la interfaz
- [HTML](/frontend/html) - Estructura de la interfaz
- [Design System](/ux-ui/design-system) - Sistema de diseño
- [Responsive Design](/ux-ui/responsive-design) - Diseño adaptable
- [Accessibility](/ux-ui/accessibility) - Accesibilidad web
