...
- [HTML](/terminos/frontend/html) - Estructura
- [CSS](/terminos/frontend/css) - Estilos
- [TypeScript](/terminos/frontend/typescript) - JavaScript tipado
- [React](/terminos/frontend/react) - Librería de JavaScript
- [Node.js](/terminos/backend/nodejs) - JavaScript en el servidor
- [DOM](/terminos/frontend/dom) - Manipulación de elementos
